...
@section('content')
    ...
    @if ($responsive)
        <link type="text/css" rel="stylesheet"
            href="{!! config('csgtcrud.pathToAssets', '/') . 'css/responsive.bootstrap.min.css' !!}>
        <script src="{!! config('csgtcrud.pathToAssets', '/') . 'js/dataTables.responsive.min.js' !!}"></script>
        <script src="{!! config('csgtcrud.pathToAssets', '/') . 'js/responsive.bootstrap.min.js' !!}"></script>
@endif
    <?php
    $fontawesome = false;
    ...
    @if ($fontawesome)
<link type="text/css"
            rel="stylesheet" href="{!! config('csgtcrud.pathToAssets', '/') . 'css/font-awesome.min.css' !!}">
    @endif
    <script>
            ...
            var oTable = $('.tabla-catalogo').dataTable({
                ...
                "columnDefs": [{
                        ...
                        "render": function(data, type, full, meta) {
                            ...
                            @if ($permisos['edit'])
                                html +=
                                    '<div class="btn-group btn-group-xs"><a class="btn btn-xs btn-primary" title="{{ trans('csgtcrud::crud.editar') }}" href="{!! URL::to(Request::url()) !!}/' +
                                    id +
                                    '/edit/{!! $nuevasVars !!}"><span class="glyphicon glyphicon-pencil"></span></a></div>';
                            @endif ;
                            @if ($permisos['delete'])
