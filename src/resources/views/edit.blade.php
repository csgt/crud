...
@section('content')
    ...
    @else
        {!! Form::open([
            'url' => URL::to($pathstore . $nuevasVars),
            'method' => 'put',
            'id' => 'frmCrud',
            'files' => 'true',
        ]) !!}
    ...
    <div class="panel panel-default">
                            ...
                            @if ($columna['tipo'] == 'password')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        @if ($data)
                                            <p class="help-block">* Dejar en blanco para no cambiar {!! $columna['nombre'] !!}
                                            </p>
                                        @endif
                                    </div>
                                </div>
        ...
        <div class="panel-footer">
            {!! Form::submit(trans('csgtcrud::crud.guardar'), ['class' => 'btn btn-primary']) !!}&nbsp;
