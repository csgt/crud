...
> **You are on branch `5.5` - package version `5.5`.**
...
| PHP         | `>= 7.0` |
| Laravel     | `>= 5.5` |
| Frontend    | Bootstrap 3 + jQuery + DataTables 1.x |
...
```bash
composer require csgt/crud:^5.5
```
...
To scaffold a controller:

```bash
php artisan make:crud ClientesController
```
